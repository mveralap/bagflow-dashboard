...
const SidebarItem = ({ icon: Icon, label, path, active }: SidebarItemProps) => (
  <Link 
    to={path} 
    className={cn(
      "flex items-center gap-3 px-4 py-3 rounded-md text-sidebar-foreground/90 hover:bg-sidebar-accent transition-all duration-200",
...
const DashboardSidebar = () => {
  ...
  return (
    <div className="h-screen bg-sidebar w-64 py-6 px-2 flex flex-col border-r border-sidebar-border fixed left-0 top-0 shadow-lg animate-fade-in">
